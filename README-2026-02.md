...
- `terra_attribution_ready` - not a tracked event; pre-populated dataLayer
...
- `search` - recommended event is tracked; auto-event view_search_results seems fine as-is
